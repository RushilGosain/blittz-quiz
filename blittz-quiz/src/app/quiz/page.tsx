...
useEffect(() => {
  ...
  if (Array.isArray(filteredQuestions)) {
    const allQuestions = filteredQuestions.slice(0, quizSetup?.questionCount || filteredQuestions.length);
    setShuffledQuestions(shuffleArray([...allQuestions]));
  }
}, [selectedQuiz, quizSetup, filteredQuestions, router]);
